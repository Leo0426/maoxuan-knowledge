...
> 个人学习与记忆强化项目。
> 以《毛泽东选集》为核心文本，通过结构化整理与可视化方式，帮助自己更系统地理解内容、建立时间脉络，并强化认知。

**MaoXuan Knowledge** 是一个围绕《毛泽东选集》构建的知识可视化系统。
它尝试将传统的线性阅读，转换为可检索、可关联、可探索的档案式阅读体验。

在线地址：**maoxuan.heyonepiece.com**
